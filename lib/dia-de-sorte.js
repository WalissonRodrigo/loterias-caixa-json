...
exports.downloadResultadosDiaDeSorte = async (customUrl) => {
  customUrl = customUrl || util.URL_LOTERIAS_CAIXA.diaDeSorte;
...
exports.downloadConcursoDiaDeSorte = async (customUrl, concurso) => {
  customUrl = customUrl || util.URL_LOTERIAS_CAIXA.diaDeSorte;
...
exports.htmlToJson = async function (htmlFile) {
  ...
  function _processData(tds) {
    ...
    var sorteio = {
      ...
      estimativa_proximo_concurso: extractResultados.getText(
        tds[index + 23 - cidadeIdx]
      ),
      valor_Acumulado_Proximo_Concurso: extractResultados.getText(
        tds[index + 24 - cidadeIdx]
      ),
