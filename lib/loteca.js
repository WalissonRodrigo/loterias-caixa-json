...
exports.downloadResultadosLoteca = async (customUrl) => {
  customUrl = customUrl || util.URL_LOTERIAS_CAIXA.loteca;
  return await util.downloadResultadosCaixa(customUrl);
};

exports.downloadResultadoLoteca = async function (customUrl) {
  customUrl = customUrl || util.URL_LOTERIAS_CAIXA.loteca;
  return await util.downloadUltimoResultadoCaixa(customUrl);
};

exports.downloadConcursoLoteca = async function (customUrl, concurso) {
  customUrl = customUrl || util.URL_LOTERIAS_CAIXA.loteca;
...
exports.htmlToJson = async function (htmlFile) {
  ...
  function _processData(tds) {
    ...
    var sorteio = {
      ...
      valor_Rateio_14_Acertos: extractResultados.getText(
        tds[index + 4 - cidadeIdx]
      ),
      acumulado: extractResultados.getText(tds[index + 5 - cidadeIdx]),
      valor_Acumulado_14_Acertos: extractResultados.getText(
        tds[index + 6 - cidadeIdx]
      ),
      ganhadores_13_Acertos: extractResultados.getText(
        tds[index + 7 - cidadeIdx]
      ),
      valor_Rateio_13_Acertos: extractResultados.getText(
        tds[index + 8 - cidadeIdx]
      ),
      ganhadores_12_Acertos: extractResultados.getText(
        tds[index + 9 - cidadeIdx]
      ),
      valor_Rateio_12_Acertos: extractResultados.getText(
        tds[index + 10 - cidadeIdx]
      ),
    ...
    var floatProps = [
      "valor_Rateio_14_Acertos",
      "acumulado",
      "valor_Acumulado_14_Acertos",
      "valor_Rateio_13_Acertos",
      "valor_Rateio_12_Acertos",
      "arrecadacao_Total",
      "estimativa_Prêmio",
    ];
    sorteio = extractResultados.propsParse(
