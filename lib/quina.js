...
exports.downloadResultadosQuina = async function (customUrl) {
  customUrl = customUrl || util.URL_LOTERIAS_CAIXA.quina;
  return await util.downloadResultadosCaixa(customUrl);
};

exports.downloadResultadoQuina = async function (customUrl) {
  customUrl = customUrl || util.URL_LOTERIAS_CAIXA.quina;
  return await util.downloadUltimoResultadoCaixa(customUrl);
};

exports.downloadConcursoQuina = async function (customUrl, concurso) {
  customUrl = customUrl || util.URL_LOTERIAS_CAIXA.quina;
    ...
    trs.each(function (index, element) {
      ...
      if (tds && tds.length > 0) {
        ...
        if (tds.length > 3) {
          ...
          sorteio.valor_Acumulado_Sorteio_Especial_Sao_Joao = util.parseToFloat(
