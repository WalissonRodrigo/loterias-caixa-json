...
exports.downloadResultadoDuplaSena = async function (customUrl) {
  customUrl = customUrl || util.URL_LOTERIAS_CAIXA.duplaSena;
  return await util.downloadUltimoResultadoCaixa(customUrl);
};

exports.downloadConcursoDuplaSena = async function (customUrl, concurso) {
  customUrl = customUrl || util.URL_LOTERIAS_CAIXA.duplaSena;
...
exports.htmlToJson = async function (htmlFile) {
  ...
  function _processData(tds) {
    ...
    let index = cidadeIdx;
    while (
      isNaN(util.parseToFloat(extractResultados.getText(tds[index]), true))
    ) {
      index++;
    }
    ...
    var sorteio = {
      ...
      rateio_Sena_Sorteio1: extractResultados.getText(
        tds[index + 11 - cidadeIdx]
      ),
      acumulado_Sena_Sorteio1: extractResultados.getText(
        tds[index + 12 - cidadeIdx]
      ),
      valor_Acumulado_Sena_Sorteio1: extractResultados.getText(
        tds[index + 13 - cidadeIdx]
      ),
      ganhadores_Quina_Sorteio1: extractResultados.getText(
        tds[index + 14 - cidadeIdx]
      ),
      rateio_Quina_Sorteio1: extractResultados.getText(
        tds[index + 15 - cidadeIdx]
      ),
      ganhadores_Quadra_Sorteio1: extractResultados.getText(
        tds[index + 16 - cidadeIdx]
      ),
      rateio_Quadra_Sorteio1: extractResultados.getText(
        tds[index + 17 - cidadeIdx]
      ),
      ganhadores_Terno_Sorteio1: extractResultados.getText(
        tds[index + 18 - cidadeIdx]
      ),
      rateio_Terno_Sorteio1: extractResultados.getText(
        tds[index + 19 - cidadeIdx]
      ),
      ...
      sorteio2: [],
      ganhadores_Sena_Sorteio2: extractResultados.getText(
        tds[index + 26 - cidadeIdx]
      ),
      rateio_Sena_Sorteio2: extractResultados.getText(
        tds[index + 27 - cidadeIdx]
      ),
      ganhadores_Quina_Sorteio2: extractResultados.getText(
        tds[index + 28 - cidadeIdx]
      ),
      rateio_Quina_Sorteio2: extractResultados.getText(
        tds[index + 29 - cidadeIdx]
      ),
      ganhadores_Quadra_Sorteio2: extractResultados.getText(
        tds[index + 30 - cidadeIdx]
      ),
      rateio_Quadra_Sorteio2: extractResultados.getText(
        tds[index + 31 - cidadeIdx]
      ),
      ganhadores_Terno_Sorteio2: extractResultados.getText(
        tds[index + 32 - cidadeIdx]
      ),
      rateio_Terno_Sorteio2: extractResultados.getText(
        tds[index + 33 - cidadeIdx]
      ),
      estimativa_Premio: extractResultados.getText(tds[index + 34 - cidadeIdx]),
      acumulado_Especial_de_Pascoa: extractResultados.getText(
        tds[index + 35 - cidadeIdx]
      ),
    };
    ...
    var intergerProps = [
      ...
      "numero_5_Sorteio1",
      "numero_6_Sorteio1",
      "ganhadores_Sena_Sorteio1",
      "ganhadores_Quina_Sorteio1",
      "ganhadores_Quadra_Sorteio1",
      "ganhadores_Terno_Sorteio1",
      "numero_1_Sorteio2",
      "numero_2_Sorteio2",
      "numero_3_Sorteio2",
      "numero_4_Sorteio2",
      "numero_5_Sorteio2",
      "numero_6_Sorteio2",
      "ganhadores_Sena_Sorteio2",
      "ganhadores_Quina_Sorteio2",
      "ganhadores_Quadra_Sorteio2",
      "ganhadores_Terno_Sorteio2",
    ];
    sorteio = extractResultados.propsParse(
      intergerProps,
      sorteio,
      util.parseToInt
    );
    ...
    var floatProps = [
      "arrecadacao_Total",
      "rateio_Sena_Sorteio1",
      "acumulado_Sena_Sorteio1",
      "valor_Acumulado_Sena_Sorteio1",
      "rateio_Quina_Sorteio1",
      "rateio_Quadra_Sorteio1",
      "rateio_Terno_Sorteio1",
      "rateio_Sena_Sorteio2",
      "rateio_Quina_Sorteio2",
      "rateio_Quadra_Sorteio2",
      "rateio_Terno_Sorteio2",
      "estimativa_Premio",
    ...
    sorteio.acumulado_Especial_de_Pascoa =
      sorteio.acumulado_Especial_de_Pascoa == "SIM";
