...
exports.downloadUltimoResultadoCaixa = async function (url) {
  ...
  // Monta a URL e faz o download dos dados em memoria
  let urlDownloadResultado =
    baseUrlToDownload.attr("href") + urlBuscarResultado.attr("href");
...
exports.downloadConcursoCaixa = async function (url, concurso) {
  ...
  let baseUrlToDownload = $("base");
  let urlBuscarResultado = $('input[id="urlBuscarResultado"]');
  let urlConcursoFilter = `c=cacheLevelPage//p=concurso=${concurso}`;
  // Monta a URL e faz o download dos dados em memoria
  let urlDownloadConcurso =
    baseUrlToDownload.attr("href") +
    urlBuscarResultado
      .attr("href")
      .replace("c=cacheLevelPage/=/", urlConcursoFilter);
