...
exports.downloadResultadoTimemania = async function (customUrl) {
  customUrl = customUrl || util.URL_LOTERIAS_CAIXA.timemania;
  return await util.downloadUltimoResultadoCaixa(customUrl);
};

exports.downloadConcursoTimemania = async function (customUrl, concurso) {
  customUrl = customUrl || util.URL_LOTERIAS_CAIXA.timemania;
